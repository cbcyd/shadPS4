...
vk::BufferView Buffer::View(u32 offset, u32 size, bool is_written, AmdGpu::DataFormat dfmt,
    ...
    const vk::BufferViewCreateInfo view_ci = {
        ...
        .format = dfmt != AmdGpu::DataFormat::Format32_32_32 ? Vulkan::LiverpoolToVK::SurfaceFormat(dfmt, nfmt) : vk::Format::eR32G32B32A32Uint, //Vulkan::LiverpoolToVK::SurfaceFormat(AmdGpu::DataFormat::Format32_32_32_32, AmdGpu::NumberFormat::Unorm), //Vulkan::LiverpoolToVK::SurfaceFormat(dfmt, nfmt),
        .offset = offset,
